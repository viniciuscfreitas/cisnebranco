...
// MRR targets removed - not applicable for pet shop services
...
// Pipeline flow: 0 -> 1 -> 2 -> 3 -> 4
const COLUMNS = [
  { id: 0, name: 'Não Chegaram' }, // Pets agendados que ainda não chegaram
  { id: 1, name: 'Aguardando' }, // Pets que chegaram e estão aguardando atendimento
  { id: 2, name: 'Em Atendimento' }, // Pets em processo de banho/tosa
